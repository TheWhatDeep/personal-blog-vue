...
export const ENEMIES = {
	...
	brute_frost: {
		...
		knockbackResist: 0.85, slamRadius: 36, lootTier: 2,
	...
	bat_frost: {
		...
		flying: true, swoopSpeed: 175, lootTier: 1,
	...
	bomber: {
		...
		fuseTime: 0.8, blastRadius: 40, lootTier: 0,
	},
	spiderling: {
	...
	summon_skeleton: {
		...
		detect: 140, attackRange: 16, attackCd: 0.8, ai: 'melee', lootTier: -1,
	},
	summon_wolf: {
		id: 'summon_wolf', name: 'Spirit Wolf', sprite: 'assassin',
		hp: 45, speed: 110, damage: 10, xp: 0, radius: 6,
		detect: 160, attackRange: 16, attackCd: 0.6, ai: 'melee', lootTier: -1,
	},
}
